 ...
 * @version 01/19/07
 * Edited and developed further by C. Thurston, 10/02/2013
 */
...
{   
    public static void main(String [ ] args)
    {
        ...
        System.out.print("Please enter a decimal value for how much money you started out with in the U.S.:  ");
        double startingUsDollars = in.nextDouble();
        System.out.print("Please enter a decimal value for how many dollars you spent in Mexico:  ");
        double dollarsSpentInMexico = in.nextDouble();
        System.out.print("Please enter a decimal value for how many dollars you spent in Japan:  ");
        double dollarsSpentInJapan = in.nextDouble();
        System.out.print("Please enter a decimal value for how many dollars you spent in France:  ");
        double dollarsSpentInFrance = in.nextDouble();
